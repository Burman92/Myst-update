            ...
            <p className='package_contents'>
                ...
                <div className='bundle_contents_preview collapsed'>
                    <div className='bundle_contents_preview_position'>
                        <a>
                            <img src='https://cdn.cloudflare.steamstatic.com/steam/subs/7/capsule_sm_120.jpg?t=1447444801' className='first_game_inside_bundle1' alt='1st game' />
                        </a>
                        <a>
                            <img src='https://cdn.cloudflare.steamstatic.com/steam/apps/300/capsule_sm_120.jpg?t=1675457675' className='second_game_inside_bundle1' alt='2nd game'/>
                        </a>
                        <a>
                            <img src='https://cdn.cloudflare.steamstatic.com/steam/apps/20/capsule_sm_120.jpg?t=1579634708' className='third_game_inside_bundle1' alt='3rd game'/>
                        </a>
                        <a>
                            <img src='https://cdn.cloudflare.steamstatic.com/steam/apps/30/capsule_sm_120.jpg?t=1512413490' className='fourth_game_inside_bundle1' alt='4th game'/>
                        </a>
                        <a>
                            <img src='https://cdn.cloudflare.steamstatic.com/steam/apps/40/capsule_sm_120.jpg?t=1568752159' className='fifth_game_inside_bundle1' alt='5th game'/>
                        </a>
                        <a>
                            <img src='https://cdn.cloudflare.steamstatic.com/steam/apps/50/capsule_sm_120.jpg?t=1579628243' className='sixth_game_inside_bundle1' alt='6th game'/>
                        </a>
                        {/* <a>
                            <img src='' className='seventh_game_inside_bundle1' alt='7th game'/>
                        </a>
                        <a>
                            <img src='' className='eighth_game_inside_bundle1' alt='8th game'/>
                        </a>
                        <a>
                            <img src='' className='ninth_game_inside_bundle' alt='9th game'/>
                        </a> */}
                    </div>
                </div>
            </p>
