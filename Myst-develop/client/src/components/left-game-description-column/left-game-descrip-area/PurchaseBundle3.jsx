            ...
            <p className='package_contents'>
                ...
                <div className='bundle_contents_preview collapsed'>
                    <div className='bundle_contents_preview_position'>
                        <a>
                            <img src='https://cdn.cloudflare.steamstatic.com/steam/apps/20/capsule_sm_120.jpg?t=1579634708' alt='Team Fortress' className='first_game_inside_bundle3' />
                        </a>
                        <a>
                            <img src='https://cdn.cloudflare.steamstatic.com/steam/apps/50/capsule_sm_120.jpg?t=1579628243' alt='Half life 1' className='second_game_inside_bundle3' />
                        </a>
                        <a>
                            <img src='https://steamcdn-a.akamaihd.net/steam/apps/280/header.jpg?t=1567598769' alt='Half life 2' className='third_game_inside_bundle3' />
                        </a>
                        <a>
                            <img src='https://cdn.cloudflare.steamstatic.com/steam/apps/130/capsule_sm_120.jpg?t=1579629868' alt='Half life 3'  className='fourth_game_inside_bundle3' />
                        </a>
                        {/* <a>
